...
const COMMAND_ITEMS: { label: string; path: string }[] = [
  ...
  { label: "Subsidy Indents", path: "/sales/subsidy-indents" },
    ...
    <div className="flex flex-col h-screen bg-background overflow-x-hidden">
      ...
      <header className="erp-topbar bg-topbar text-topbar-foreground flex items-center h-12 px-2 sm:px-3 gap-2 sm:gap-3 shadow-md no-print shrink-0">
        ...
        <div className="flex items-center gap-2 pr-3 border-r border-white/10">
          <div className="h-7 px-1 rounded-sm bg-white grid place-items-center">
            <img src="/assets/logo.png" alt="Havemul" className="h-5 w-auto object-contain" />
          </div>
          <div className="leading-tight">
            <div className="text-[13px] font-semibold">Havemul</div>
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <main className="erp-main flex-1 min-w-0 flex flex-col">
          ...
          <div className="print-only print-footer">
            ...
            <span>Havemul ERP · Confidential</span>
          </div>
